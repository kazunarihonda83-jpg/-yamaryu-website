                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 mb-6">
                            <li>• <strong data-en="Premium tongue (上タン)" data-ja="上タン" data-zh="特选牛舌">Premium tongue (上タン)</strong> - <span data-en="Rich, tender, melt-in-your-mouth" data-ja="濃厚で柔らか、口の中でとろける" data-zh="浓郁、柔嫩、入口即化">Rich, tender, melt-in-your-mouth</span></li>
                            <li>• <strong data-en="Premium loin (上ロース)" data-ja="上ロース" data-zh="特选里脊">Premium loin (上ロース)</strong> - <span data-en="Perfectly marbled for maximum flavor" data-ja="完璧な霜降りで最高の風味" data-zh="完美的大理石纹理，风味十足">Perfectly marbled for maximum flavor</span></li>
                            <li>• <strong data-en="Aged premium skirt steak (熟成上はらみ)" data-ja="熟成上はらみ" data-zh="熟成特选横膈膜">Aged premium skirt steak (熟成上はらみ)</strong> - <span data-en="Our signature aged cut" data-ja="当店自慢の熟成肉" data-zh="我们的招牌熟成肉">Our signature aged cut</span></li>
                            <li>• <strong data-en="Assorted premium wagyu" data-ja="和牛盛り合わせ" data-zh="精选和牛拼盘">Assorted premium wagyu</strong> - <span data-en="Selected by our expert butcher daily" data-ja="肉職人が毎日厳選" data-zh="每日由专业屠夫精选">Selected by our expert butcher daily</span></li>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="card">
                    ...
                    <div class="bg-blue-50 p-3 rounded text-xs">
                        📝 <strong data-en="Note:" data-ja="注意：" data-zh="注意：">Note:</strong> <span data-en="Please provide allergy details at least 24 hours before your visit to ensure proper preparation." data-ja="適切な準備のため、訪問の少なくとも24時間前にアレルギー詳細をお知らせください。" data-zh="请至少在到访前24小时提供过敏详情，以确保妥善准备。">Please provide allergy details at least 24 hours before your visit to ensure proper preparation.</span>
                    </div>
                </div>
