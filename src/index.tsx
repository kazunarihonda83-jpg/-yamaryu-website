...
<body class="bg-gray-50">
    ...
    <!-- Hero Section -->
    <section class="relative h-screen flex items-center justify-center text-white" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1588347818036-8fc8d179e69c?w=1600') center/cover;">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <p class="text-center text-lg mb-12" data-en="Carefully Selected for Your Enjoyment" data-ja="お客様の喜びのために厳選" data-zh="精心挑选，为您而备" data-zh="为您精心挑选">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        <div class="inline-block bg-yellow-400 text-black px-3 py-1 rounded-full text-sm font-bold mb-4">
                            🏆 <span data-en="Most Popular" data-ja="人気No.1" data-zh="最受欢迎" data-zh="最受欢迎">Most Popular</span>
                        </div>
                        <h3 class="text-3xl font-bold mb-4" data-en="YAMARYU Premium Wagyu Set (Full)" data-ja="やま龍 上撰セット（3〜4名様用）" data-zh="YAMARYU 特选和牛套餐（全份）" data-zh="YAMARYU特选和牛套餐（3-4人份）">YAMARYU Premium Wagyu Set (Full)</h3>
                        <p class="text-2xl text-red-700 font-bold mb-4">¥8,118 <span class="text-sm font-normal" data-en="(tax included, for 3-4 people)" data-ja="（税込・3〜4名様用）" data-zh="（含税，3-4人份）" data-zh="（含税，3-4人份）">(tax included, for 3-4 people)</span></p>
                        <p class="mb-4" data-en="Our butcher's choice of the day's finest wagyu cuts, beautifully presented with grilled seasonal vegetables. This generous set includes:" data-ja="その日の最高級和牛を、肉職人が厳選。美しく盛り付けられた旬の焼き野菜とともに。このボリューム満点のセットには以下が含まれます：" data-zh="我们的屠夫精选当日最优质的和牛部位，搭配精美呈现的时令烤蔬菜。这份丰盛的套餐包括：" data-zh="我们的屠夫精选当日最优质的和牛部位，搭配精美呈现的时令烤蔬菜。这份丰盛的套餐包括：">
                        ...
                        <ul class="space-y-2 mb-6">
                            <li>• <strong data-en="Premium tongue (上タン)" data-ja="上タン" data-zh="特选牛舌（上タン）" data-zh="特选牛舌">Premium tongue (上タン)</strong> - <span data-en="Rich, tender, melt-in-your-mouth" data-ja="濃厚で柔らか、口の中でとろける" data-zh="浓郁、柔嫩、入口即化" data-zh="浓郁、柔嫩、入口即化">Rich, tender, melt-in-your-mouth</span></li>
                            <li>• <strong data-en="Premium loin (上ロース)" data-ja="上ロース" data-zh="特选里脊（上ロース）" data-zh="特选里脊">Premium loin (上ロース)</strong> - <span data-en="Perfectly marbled for maximum flavor" data-ja="完璧な霜降りで最高の風味" data-zh="完美的大理石纹理，风味十足" data-zh="完美的大理石纹理，风味十足">Perfectly marbled for maximum flavor</span></li>
                            <li>• <strong data-en="Aged premium skirt steak (熟成上はらみ)" data-ja="熟成上はらみ" data-zh="熟成特选横膈膜" data-zh="熟成特选横膈膜（熟成上はらみ）" data-zh="熟成特选横膈膜">Aged premium skirt steak (熟成上はらみ)</strong> - <span data-en="Our signature aged cut" data-ja="当店自慢の熟成肉" data-zh="我们的招牌熟成肉" data-zh="我们的招牌熟成肉">Our signature aged cut</span></li>
                            <li>• <strong data-en="Assorted premium wagyu" data-ja="和牛盛り合わせ" data-zh="精选和牛拼盘" data-zh="精选和牛拼盘">Assorted premium wagyu</strong> - <span data-en="Selected by our expert butcher daily" data-ja="肉職人が毎日厳選" data-zh="每日由专业屠夫精选" data-zh="每日由专业屠夫精选">Selected by our expert butcher daily</span></li>
                            <li>• <strong data-en="Seasonal grilled vegetables" data-ja="旬の焼き野菜" data-zh="时令烤蔬菜" data-zh="时令烤蔬菜">Seasonal grilled vegetables</strong></li>
                        </ul>
                        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4">
                            <p class="text-sm" data-en="Perfect for sharing and discovering the full range of wagyu flavors." data-ja="シェアして和牛の多彩な味わいを発見するのに最適です。" data-zh="非常适合分享，探索和牛的全方位风味。" data-zh="非常适合分享，探索和牛的全方位风味。">
                                Perfect for sharing and discovering the full range of wagyu flavors.
                            </p>
                        </div>
                        
                        <h4 class="text-xl font-bold mt-6 mb-2" data-en="Half Set (1.5-2 People)" data-ja="ハーフセット（1.5〜2名様用）" data-zh="半份套餐（1.5-2人份）" data-zh="半份套餐（1.5-2人份）">Half Set (1.5-2 People)</h4>
                        <p class="text-xl text-red-700 font-bold mb-2">¥5,368 <span class="text-sm font-normal" data-en="(tax included)" data-ja="（税込）" data-zh="（含税）" data-zh="（含税）">(tax included)</span></p>
                        <p class="text-sm" data-en="All the quality of our full set, perfectly portioned for two. Ideal for couples or those who want to try our premium selection without overordering." data-ja="フルセットと同じ品質を、2名様にちょうど良い量で。カップルや、過度な注文を避けたい方に最適です。" data-zh="与全份套餐品质相同，完美的双人份量。非常适合情侣或希望在不过量点餐的情况下品尝我们精选套餐的客人。" data-zh="与全份套餐品质相同，完美的双人份量。非常适合情侣或希望不过量点餐的客人。">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div class="order-2 md:order-1">
                        ...
                        <div class="bg-red-50 border-l-4 border-red-400 p-4 mb-4">
                            <p class="text-sm"><strong data-en="Recommended cooking:" data-ja="おすすめの焼き方：" data-zh="推荐烹饪方式：" data-zh="推荐烹饪方式：">Recommended cooking:</strong> <span data-en="Medium-rare for maximum tenderness" data-ja="ミディアムレアで最高の柔らかさ" data-zh="五分熟最为柔嫩" data-zh="五分熟最为柔嫩">Medium-rare for maximum tenderness</span></p>
                        </div>
                        <p class="text-sm italic" data-en="Popular with guests who appreciate quality over quantity." data-ja="量より質を重視するお客様に人気です。" data-zh="深受注重品质胜过数量的客人喜爱。" data-zh="深受注重品质胜过数量的客人喜爱。">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        <div class="inline-block bg-green-500 text-white px-3 py-1 rounded-full text-sm font-bold mb-4">
                            👨‍👩‍👧‍👦 <span data-en="Family Favorite" data-ja="ファミリーに人気" data-zh="家庭最爱" data-zh="家庭最爱">Family Favorite</span>
                        </div>
                        <h3 class="text-3xl font-bold mb-4" data-en="Stone-Baked Yakiniku Pizza Bianco" data-ja="焼肉ピザ ビアンコ" data-zh="石烤烤肉白披萨" data-zh="石烤烤肉白披萨">Stone-Baked Yakiniku Pizza Bianco</h3>
                        <p class="text-2xl text-red-700 font-bold mb-4">¥1,738 <span class="text-sm font-normal" data-en="(tax included)" data-ja="（税込）" data-zh="（含税）" data-zh="（含税）">(tax included)</span></p>
                        <p class="mb-4" data-en="A YAMARYU original: Premium wagyu meets Italian stone-oven pizza. Thin, crispy crust topped with our tender beef, fresh cheese, and aromatic herbs. Baked to perfection in our traditional stone oven." data-ja="やま龍オリジナル：最高級和牛とイタリアの石窯ピザの出会い。薄くてパリパリのクラストに、柔らかな牛肉、新鮮なチーズ、香り高いハーブをトッピング。伝統的な石窯で完璧に焼き上げます。" data-zh="YAMARYU原创：优质和牛遇见意式石窑披萨。薄脆的饼底，配上我们柔嫩的牛肉、新鲜奶酪和芳香草本。在传统石窑中烤制至完美。" data-zh="YAMARYU原创：优质和牛遇见意式石窑披萨。薄脆的饼底，配上我们柔嫩的牛肉、新鲜奶酪和芳香草本。在传统石窑中烤制至完美。">
                        ...
                        <h4 class="font-bold mb-2" data-en="Why guests love it:" data-ja="お客様が愛する理由：" data-zh="客人喜爱的理由：" data-zh="客人喜爱的理由：">Why guests love it:</h4>
                        <ul class="space-y-2 mb-6">
                            <li>• <span data-en="Children adore it (great for families!)" data-ja="お子様が大好き（ファミリーに最適！）" data-zh="孩子们超爱（家庭聚餐首选！）" data-zh="孩子们超爱（家庭聚餐首选！）">Children adore it (great for families!)</span></li>
                            <li>• <span data-en="Lighter option for those who want variety" data-ja="バラエティを求める方に軽めの選択肢" data-zh="想要多样化的轻量选择" data-zh="想要多样化的轻量选择">Lighter option for those who want variety</span></li>
                            <li>• <span data-en="Unique fusion you won't find elsewhere" data-ja="他では味わえないユニークな融合" data-zh="独一无二的融合，别处难觅" data-zh="独一无二的融合，别处难觅">Unique fusion you won't find elsewhere</span></li>
                            <li>• <span data-en="Perfect with wine or beer" data-ja="ワインやビールに完璧にマッチ" data-zh="搭配葡萄酒或啤酒完美" data-zh="搭配葡萄酒或啤酒完美">Perfect with wine or beer</span></li>
                        </ul>
                        <div class="bg-green-50 border-l-4 border-green-400 p-4">
                            <p class="text-sm italic" data-en="\"It's like yakiniku and pizza had a delicious baby\" - Our guests" data-ja="「焼肉とピザが美味しい赤ちゃんを産んだみたい」- お客様の声" data-zh=""就像烤肉和披萨生了个美味宝宝" - 我们的客人" data-zh=""就像烤肉和披萨生了个美味宝宝" - 我们的客人">
            ...
            <div class="mt-8 text-center bg-yellow-50 p-6 rounded-lg">
                <p class="text-lg">💡 <span data-en="Not sure what to order? Our staff are happy to recommend based on your preferences. Just ask when you reserve!" data-ja="何を注文すればいいかわからない？スタッフがお好みに合わせておすすめします。予約時にお気軽にお尋ねください！" data-zh="不确定点什么？我们的员工很乐意根据您的喜好推荐。预订时随时询问！" data-zh="不确定点什么？我们的员工很乐意根据您的喜好推荐。预订时随时询问！">Not sure what to order? Our staff are happy to recommend based on your preferences. Just ask when you reserve!</span></p>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-amber-50">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <p class="text-center text-lg mb-12" data-en="Your Safety & Comfort Matter to Us" data-ja="お客様の安全と快適さを大切にします" data-zh="您的安全与舒适至关重要" data-zh="您的安全与舒适至关重要">
                Your Safety & Comfort Matter to Us
            </p>
            
            <p class="text-center max-w-3xl mx-auto mb-12" data-en="At YAMARYU, we believe everyone deserves to enjoy exceptional wagyu—regardless of dietary restrictions or religious requirements. Our small team takes pride in accommodating your needs with care and respect." data-ja="やま龍では、食事制限や宗教的な要件に関わらず、すべての人が最高の和牛を楽しむべきだと信じています。少人数のチームだからこそ、心を込めて丁寧に対応いたします。" data-zh="在YAMARYU，我们相信每个人都应该享受卓越的和牛——无论饮食限制或宗教要求如何。我们的小团队以用心和尊重满足您的需求为荣。" data-zh="在YAMARYU，我们相信每个人都应该享受卓越的和牛——无论饮食限制或宗教要求如何。我们的小团队以用心和尊重满足您的需求为荣。">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="card">
                    ...
                    <p class="text-xs font-bold mb-2" data-en="Common allergens we can accommodate:" data-ja="対応可能な主なアレルゲン：" data-zh="我们可应对的常见过敏原：" data-zh="我们可应对的常见过敏原：">Common allergens we can accommodate:</p>
                    <p class="text-xs mb-4">✓ Shellfish • ✓ Nuts • ✓ Soy • ✓ Gluten • ✓ Dairy</p>
                    <div class="bg-blue-50 p-3 rounded text-xs">
                        📝 <strong data-en="Note:" data-ja="注意：" data-zh="注意：" data-zh="注意：">Note:</strong> <span data-en="Please provide allergy details at least 24 hours before your visit to ensure proper preparation." data-ja="適切な準備のため、訪問の少なくとも24時間前にアレルギー詳細をお知らせください。" data-zh="请至少在到访前24小时提供过敏详情，以确保妥善准备。" data-zh="请至少在到访前24小时提供过敏详情，以确保妥善准备。">Please provide allergy details at least 24 hours before your visit to ensure proper preparation.</span>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="text-5xl mb-4">🕌</div>
                    <h3 class="font-bold text-xl mb-3" data-en="Muslim-Friendly Considerations" data-ja="ムスリムフレンドリー対応" data-zh="穆斯林友好考虑" data-zh="穆斯林友好考虑">Muslim-Friendly Considerations</h3>
                    <p class="text-sm mb-4" data-en="While we are not a certified halal restaurant, we respect religious dietary laws and will do our best to accommodate your needs." data-ja="認証ハラールレストランではありませんが、宗教的な食事規則を尊重し、可能な限り対応いたします。" data-zh="虽然我们不是经认证的清真餐厅，但我们尊重宗教饮食法规，并将尽力满足您的需求。" data-zh="虽然我们不是经认证的清真餐厅，但我们尊重宗教饮食法规，并将尽力满足您的需求。">
                    ...
                    <p class="text-xs mb-4" data-en="We can:" data-ja="対応可能なこと：" data-zh="我们可以：" data-zh="我们可以：">We can:</p>
                    <ul class="text-xs space-y-1 mb-4">
                        <li>• <span data-en="Prepare meals with dedicated cookware" data-ja="専用調理器具で調理" data-zh="使用专用炊具准备餐点" data-zh="使用专用炊具准备餐点">Prepare meals with dedicated cookware</span></li>
                        <li>• <span data-en="Provide ingredient lists for all dishes" data-ja="全料理の原材料リスト提供" data-zh="提供所有菜品的配料清单" data-zh="提供所有菜品的配料清单">Provide ingredient lists for all dishes</span></li>
                        <li>• <span data-en="Offer alternative menu options" data-ja="代替メニューの提案" data-zh="提供替代菜单选项" data-zh="提供替代菜单选项">Offer alternative menu options</span></li>
                        <li>• <span data-en="Arrange consultations with our chef" data-ja="シェフとの事前相談" data-zh="安排与厨师的咨询" data-zh="安排与厨师的咨询">Arrange consultations with our chef</span></li>
                    </ul>
                    <div class="bg-green-50 p-3 rounded text-xs">
                        🤝 <span data-en="We welcome discussion: Contact us when booking to discuss your specific requirements." data-ja="ご相談歓迎：予約時に具体的なご要望をお聞かせください。" data-zh="欢迎讨论：预订时联系我们讨论您的具体要求。" data-zh="欢迎讨论：预订时联系我们讨论您的具体要求。">We welcome discussion: Contact us when booking to discuss your specific requirements.</span>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="text-5xl mb-4">🥗</div>
                    <h3 class="font-bold text-xl mb-3" data-en="Vegetarian & Special Diets" data-ja="ベジタリアン・特別食" data-zh="素食与特殊饮食" data-zh="素食与特殊饮食">Vegetarian & Special Diets</h3>
                    <p class="text-sm mb-4" data-en="While yakiniku is traditionally meat-focused, we offer options for various dietary preferences:" data-ja="焼肉は伝統的に肉中心ですが、様々な食事嗜好に対応するオプションをご用意しています：" data-zh="虽然烤肉传统上以肉类为主，但我们为各种饮食偏好提供选项：" data-zh="虽然烤肉传统上以肉类为主，但我们为各种饮食偏好提供选项：">
                    ...
                    <ul class="text-xs space-y-2 mb-4">
                        <li>✓ <span data-en="Grilled vegetable platters (fresh seasonal vegetables)" data-ja="焼き野菜盛り合わせ（新鮮な旬野菜）" data-zh="烤蔬菜拼盘（新鲜时令蔬菜）" data-zh="烤蔬菜拼盘（新鲜时令蔬菜）">Grilled vegetable platters (fresh seasonal vegetables)</span></li>
                        <li>✓ <span data-en="Rice dishes without animal products" data-ja="動物性食品不使用の米料理" data-zh="无动物制品的米饭菜肴" data-zh="无动物制品的米饭菜肴">Rice dishes without animal products</span></li>
                        <li>✓ <span data-en="Gluten-free soy sauce alternative" data-ja="グルテンフリー醤油代替品" data-zh="无麸质酱油替代品" data-zh="无麸质酱油替代品">Gluten-free soy sauce alternative</span></li>
                        <li>✓ <span data-en="Custom vegetable-based sides" data-ja="カスタム野菜ベースサイド" data-zh="定制蔬菜配菜" data-zh="定制蔬菜配菜">Custom vegetable-based sides</span></li>
                    </ul>
                    <div class="bg-purple-50 p-3 rounded text-xs">
                        <span data-en="Let us know your requirements when booking—we'll ensure you have delicious options to enjoy." data-ja="予約時にご要望をお知らせください。美味しい選択肢をご用意いたします。" data-zh="预订时告知您的要求——我们将确保您有美味的选项可享用。" data-zh="预订时告知您的要求——我们将确保您有美味的选项可享用。">Let us know your requirements when booking—we'll ensure you have delicious options to enjoy.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12 text-center">
                ...
                <p data-en="Contact us through Instagram or our reservation form—we're here to help!" data-ja="Instagramまたはオンラインフォームでお問い合わせください。喜んでお手伝いいたします！" data-zh="通过Instagram或预订表格联系我们——我们随时为您服务！" data-zh="通过Instagram或预订表格联系我们——我们随时为您服务！">Contact us through Instagram or our reservation form—we're here to help!</p>
                <a href="#reservation-form" class="btn-primary mt-4">
                    <span data-en="Contact Us Now" data-ja="今すぐお問い合わせ" data-zh="立即联系我们" data-zh="立即联系我们">Contact Us Now</span>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <p class="text-center text-lg mb-12" data-en="What to Expect at YAMARYU" data-ja="やま龍でのご体験" data-zh="在YAMARYU的体验" data-zh="在YAMARYU的体验">
            ...
            <div class="space-y-12">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div class="md:w-3/4">
                        ...
                        <p class="italic mt-2 text-sm opacity-75" data-en="\"Finally, a place where we didn't feel like tourists—we felt like guests.\"" data-ja="「ようやく、観光客ではなくゲストとして扱われる場所を見つけました。」" data-zh=""终于找到一个让我们感觉不像游客——而像宾客的地方。"" data-zh=""终于找到一个让我们感觉不像游客——而像宾客的地方。"">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div class="md:w-3/4 order-1 md:order-2">
                        ...
                        <p class="mt-2 font-bold text-sm" data-en="You'll learn while you eat—it's part of the fun!" data-ja="食べながら学ぶ—それも楽しみの一部です！" data-zh="您将在用餐中学习——这也是乐趣的一部分！" data-zh="您将在用餐中学习——这也是乐趣的一部分！">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div class="md:w-3/4">
                        ...
                        <p class="italic mt-2 text-sm opacity-75" data-en="\"We've had wagyu before, but never like this. You can taste the quality.\"" data-ja="「和牛は以前にも食べたことがありますが、こんなのは初めて。品質が味でわかります。」" data-zh=""我们以前吃过和牛，但从未像这样。您可以品尝到品质。"" data-zh=""我们以前吃过和牛，但从未像这样。您可以品尝到品质。"">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-center">
                    <div class="md:w-1/4 text-center order-2 md:order-1">
                        <div class="text-6xl mb-4">🍷</div>
                        <h3 class="font-bold text-xl" data-en="Your Private Space" data-ja="プライベート空間" data-zh="您的私密空间" data-zh="您的私密空间">Your Private Space</h3>
                    </div>
                    <div class="md:w-3/4 order-1 md:order-2">
                        <p data-en="No rush. No crowds pressing in. Just you, your companions, and exceptional food in a space that feels like it's yours alone. This is dining as it should be—relaxed, intimate, memorable." data-ja="焦る必要はありません。押し寄せる人混みもありません。あなたと仲間、そして特別な料理だけが、あなただけの空間のように感じられます。これが本来の食事のあり方—リラックスして、親密で、忘れられない。" data-zh="不必匆忙。没有拥挤的人群。只有您、您的同伴和卓越的美食，在一个仿佛专属于您的空间。这才是用餐的应有之道——放松、私密、难忘。" data-zh="不必匆忙。没有拥挤的人群。只有您、您的同伴和卓越的美食，在一个仿佛专属于您的空间。这才是用餐的应有之道——放松、私密、难忘。">
                        ...
                        <p class="mt-2 font-bold text-sm" data-en="Take photos. Laugh together. Create memories." data-ja="写真を撮って。一緒に笑って。思い出を作りましょう。" data-zh="拍照留念。一起欢笑。创造回忆。" data-zh="拍照留念。一起欢笑。创造回忆。">
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <p class="text-center text-lg mb-12" data-en="Real Experiences from Travelers Like You" data-ja="あなたのような旅行者の本物の体験" data-zh="像您一样的旅行者的真实体验" data-zh="像您一样的旅行者的真实体验">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card bg-white">
                    ...
                    <div class="text-yellow-400 mb-3">⭐⭐⭐⭐⭐</div>
                    <p class="text-sm" data-en="\"Booking through Instagram was so easy, and the response was almost immediate. The intimate setting was perfect for our anniversary dinner. You can tell this is a family-run place that truly cares about each guest.\"" data-ja="「Instagramでの予約はとても簡単で、返信もほぼ即座でした。親密な雰囲気は記念日ディナーに完璧でした。ここは家族経営で、一人ひとりのゲストを本当に大切にしていることがわかります。」" data-zh=""通过Instagram预订非常简单，回复几乎是即时的。亲密的氛围非常适合我们的周年纪念晚餐。你可以看出这是一家家庭经营的餐厅，真正关心每一位客人。"" data-zh=""通过Instagram预订非常简单，回复几乎是即时的。私密的氛围非常适合我们的纪念日晚餐。您可以看出这是一家家族企业，真正关心每一位客人。"">
